-- this file is included only for context
...
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'The date/time that the migration finished executing. This value is populated using the SYSDATETIME function.' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'__MigrationLog', @level2type=N'COLUMN',@level2name=N'complete_dt'
GO
